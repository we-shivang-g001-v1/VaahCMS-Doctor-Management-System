...
class DoctorsController extends Controller
{
    ...
    public function getDoctorPriceRange(Request $request)
    {
        try {
           return Doctor::getDoctorPriceRange();
        } catch (\Exception $e) {
            $response = [];
            $response['success'] = false;
    ...
    public function doctorSampleExport(Request $request)
    {
        try {
            return Doctor::doctorSampleExport($request);
        } catch (\Exception $e) {
            $response = [];
            $response['success'] = false;
            if (env('APP_DEBUG')) {
